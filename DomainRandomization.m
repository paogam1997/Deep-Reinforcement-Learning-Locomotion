...
stat_terr_friction.distribution_parameters = [[0.7, 1];
                                              [0.3, 1.3]];
stat_terr_friction.frequency_interval = 1000;
...
dyn_terr_friction.distribution_parameters = [[0.7, 1];
                                             [0.15, 1.3]];
dyn_terr_friction.frequency_interval = 1000;
...
restitution.distribution_parameters = [[0.5, 1];
                                       [0.2, 1.]];
restitution.frequency_interval = 1000;
...
joint_armatures.distribution_parameters = [[2*10^-3, 4*10^-3]; 
                                           [0, 0]];
