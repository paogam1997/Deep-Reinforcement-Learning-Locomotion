...
actionRateRewardScale = -0.0075;                                                      % [adim] quadratic penality coeff
...
fBc_scale = 2;                                                                        % [adim] scale coeff of local penality-local bonus blending coeff
...
% desiderata
rewangvelz =  angularVelocityZRewardScale * exp(-(yawratecomm - yawrate).^2 /(2*varangvel))% + angularVelocityZPenalityScale *(yawratecomm - yawrate).^2 ;
