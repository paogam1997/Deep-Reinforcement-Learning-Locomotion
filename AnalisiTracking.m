...
% Test
%Policy_name = {'RGR2ET2', 'BGR4ET3', 'EGREET3'};               % Policy testate
%color = ["#EDB120", "#77AC30", "#0072BD"];                      % Associo ad ogni policy un colore per distinguerla nei grafici
...
Results.RGR2ET2.spost = [[1.31, 1.385, 1.45];          % vx=0.3
...
Results.RGR2ET2.dev_or = [[0.43, 0.19, 0.195];         % vx=0.3
                           [0.05, 0.094, 0];            % vx=0.5
                           [0.03, 0.07, 0];             % vx=0.7
